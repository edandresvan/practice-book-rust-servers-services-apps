...
pub async fn get_courses_for_tutor(
  ...
  let courses: Vec<Course> = get_courses_for_tutor_db(&app_state.db, tutor_id).await;
...
pub async fn get_course_details(
  ...
  let courses: Vec<Course> = get_course_details_db(&app_state.db, tutor_id as i32, course_id as i32).await;
